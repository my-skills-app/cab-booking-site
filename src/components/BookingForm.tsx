    ...
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-10 border border-border max-w-2xl mx-auto overflow-y-auto max-h-[90vh] sm:max-h-none">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input id="pickup" placeholder="Enter Pickup City" required className="h-12 rounded-lg" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="drop">Drop Location *</Label>
          <Input id="drop" placeholder="Enter Destination City" required className="h-12 rounded-lg" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="date">Travel Date *</Label>
          <Input id="date" type="date" required className="h-12 rounded-lg" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="time">Booking Time *</Label>
          <Input id="time" type="time" required className="h-12 rounded-lg" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="name">Name *</Label>
          <Input id="name" placeholder="Your Name" required className="h-12 rounded-lg" />
        </div>

        <div className="space-y-2">
          <Label htmlFor="phone">Phone *</Label>
          <Input id="phone" placeholder="Your Mobile Number" required className="h-12 rounded-lg" />
        </div>
