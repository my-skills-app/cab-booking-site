...
import { prebuiltPageData } from "@/lib/prebuilt-page-data";
import { siteConfig } from "@/lib/site-config";

const PrebuiltPage = () => {
  const { hero, solutions } = prebuiltPageData;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {solutions.items.map((item, index) => (
                ...
                >
                    ...
                    <Button asChild>
                    <Link href={item.link}>View Details <ArrowUpRight className="h-4 w-4" /></Link>
                    </Button>
                </motion.div>
              ))}
            </div>
